...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--load_fed', type=str, default='Resnet_Cifar10_iid_100_rounds_baseline', help='define pretrained federated model path,\
                        VGG9_Cifar10_iid_40_rounds_baseline, MLP_Mnist_iid_40_rounds_baseline,CNN_Mnist_iid_40_rounds_baseline,Resnet_Cifar10_iid_100_rounds_baseline')
    ...
    parser.add_argument('--attack', type=str,
                        default='lp_attack', help='attack method')
    ...
    parser.add_argument('--defence', type=str,
                        default='ours', help="strategy of defence")
